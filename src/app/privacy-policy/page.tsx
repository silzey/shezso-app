    ...
    <div className="flex flex-col min-h-screen bg-muted/40">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 pt-24 md:pt-8">
        <article className="prose lg:prose-xl max-w-4xl mx-auto bg-background p-8 rounded-lg shadow">
            ...
            <p>Welcome to Shezso. You must be 21 and over. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us.</p>
